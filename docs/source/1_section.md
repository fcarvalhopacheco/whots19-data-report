...
```{figure} /figures/diagram/whots19-diagram.png
:height: 1000px
:align: center
:name: diagram
...
{ref}`III</3_section.md#description-of-WHOTS-19-mooring>` include a detailed
...
{ref}`IV</4_section.md#WHOTS-19-20-cruise-shipboard-observations>`. Section
