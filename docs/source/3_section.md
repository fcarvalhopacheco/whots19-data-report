...
deployed on June 17, 2023, 
from R/V Oscar Elton Settle, was outfitted with two complete 
...
COVID-19 pandemic. The WHOTS-19 
was recovered on 
June 06, 2024.
...
Instrumentation provided by UH for the WHOTS-19 mooring included 20 SBE-37
...
The {numref}`mooring_subsurface` provides a listing of the WHOTS-19 subsurface
...
WHOTS-19 mooring subsurface instrument deployment information. All times 
are in UTC
```

```{table} WHOTS-19 mooring C-T and ADCP Instruments recovery information. All times are in UTC (mm/dd/yy hh:mm:ss). Sea-Bird 37 Serial Number (SN). 
:name: table-8
:widths: auto
:align: center
...
{numref}`table-10`, and {ref}`/appendices.md#whots-19-300-khz-serial-4891` for
...
, {numref}`table-10`, and {ref}`/appendices.md#whots-19-600-khz-serial-1825`
...
All WHOTS-19 instruments were successfully recovered; recovery information for
