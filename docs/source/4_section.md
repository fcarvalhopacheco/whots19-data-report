...
#91361 and #850 during WHOTS-19 and WHOTS-20 cruises respectively. The CTD was
...
used during WHOTS-19 and WHOTS-20 cruises respectively employed a high-quality
...
2021, before the WHOTS-20 cruise, which used the same oxygen sensors.
...
SN 70168 for WHOTS-19 and SN 73647 for WHOTS-20. International Association for
...
2019, and it was used for WHOTS-19. The batch #71 was prepared on August 27,
2021, and it was used for WHOTS-20.
...
|:----------------------------------------------------------:|:------------------------:|:-------------:|:---------------------:|:---------------:|
| **WHOTS-19** |     3x.xxxx ± 0.000x     |       x       |          xx           |      P1xx       |
|      **WHOTS-20**      |     3x.xxxx ± 0.000x     |      xx       |          xx           |      P1xx       |
```
...
eleven CTD casts conducted during WHOTS-19 while the thermosalinograph was
...
There were 11 CTD casts conducted during WHOTS-19, one of which was a test cast
offshore Honolulu (Station 20) and five at Station 50 (WHOTS-19), and five at
Station 52 (WHOTS-18), respectively. 
...
There were ten CTD casts conducted during WHOTS-20, one of which was a test
cast offshore Honolulu (Station 20), one at Aloha Station (Station 2), five at
Station 52 (WHOTS-20), and 
two at Station 50 (WHOTS-19). The 4 dbar downcast
...
{cite}`Santiago-Mandujano2022`) during operations near the WHOTS-19 and
WHOTS-20 moorings. The broadband system only recorded good data in the upper
200 m. The times of the datasets from the OS75 kHz are shown in
{numref}`table-13`.

```{table} ADCP record times (UTC mm/dd/yy hh:mm:ss) for the Narrow Band 75 kHz ADCP during the WHOTS-20 cruise
:class: sd-m-auto
:align: center
:name: table-13
